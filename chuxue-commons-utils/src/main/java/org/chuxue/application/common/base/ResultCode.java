...
public enum ResultCode {
    ...
    /* 业务错误 */
	NO_PERMISSION(3001, ResultMessage.NO_PERMISSION), NO_DATA(4002, ResultMessage.NO_DATA),
	
    /* 异常抛出 */
	NULL_EXCEPTION(4002, ResultMessage.NULL_EXCEPTION), NOT_FIND_EXCEPTION(4003, ResultMessage.NOT_FIND_EXCEPTION), DATA_TRANC_EXCEPTION(4004, ResultMessage.DATA_TRANC_EXCEPTION)
	//
	;
